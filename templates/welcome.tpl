...
{block name=title}EAB - Thank You{/block}
{block name=head}
<style>
	body{
	...
	<div class="container">
		<div class="row">
			<div class="col d-flex" style="flex-direction: column;justify-content: center;width: 100%;height: 100vh;text-align: center;">
				...
				<p class="text-white" style="font-size: 24px;">You will recieve an email to login once your account is approved. You will hear back from us soon!!!! ends end</p>
			</div>
		</div>
	</div>
</section>
